package edu.nwmissouri.isl.aasis.case.org.poker.organizer;
...
/**
 * The {@code PokerReorganizationAlgorithm} extends {@code edu.ksu.cis.macr.obaa_pp.cc.reorg.AbstractReorganizationAlgorithm} to provide a custom algorithm for
 * adapting the participant assignments to best meet the organization goals.
 */
public class PokerReorganizationAlgorithm extends AbstractReorganizationAlgorithm {

    private static final Logger LOG = LoggerFactory.getLogger(PokerReorganizationAlgorithm.class);
     ...
     */
    private PokerReorganizationAlgorithm(String owner) {
        super();
        PokerReorganizationAlgorithm.owner = owner;
    }

    public static PokerReorganizationAlgorithm createReorganizationAlgorithm(final String owner) {
        return new PokerReorganizationAlgorithm(owner);
    }
    ...
    public synchronized Set<Assignment> reorganize(final IOrganizationModel org, final Set<InstanceGoal<?>> goals, final Set<Agent<?>> agents) {
        ...
        if (debug)
            LOG.debug("Reorg: Goals={}, Agents={}, Current Assignments={}, UnassignedGoals={}", goals, agents, currentAssignments, unassignedGoals);
