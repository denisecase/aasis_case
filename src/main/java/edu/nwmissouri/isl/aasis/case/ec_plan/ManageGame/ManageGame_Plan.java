...
public class ManageGame_Plan extends AbstractExecutablePlan implements IExecutablePlan {
    public ManageGame_Plan() {
        getStateMachine().setCurrentState(ManageGame_Init.INSTANCE);
    }
