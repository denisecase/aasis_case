...
import edu.nwmissouri.isl.aasis.case.org.tictactoe.organizer.TicTacToeReorganizationAlgorithm;
import edu.nwmissouri.isl.aasis.case.primary.capabilities.manage.Master;
 ...
 */
public class TicTacToeMaster extends Master implements IPersonaControlComponentMaster {
    private static final Logger LOG = LoggerFactory.getLogger(TicTacToeMaster.class);
     ...
     */
    public TicTacToeMaster(final String name, final IPersona persona, final Element knowledge, final OrganizationFocus focus) {
        super(name, persona, knowledge, focus);
        if (debug) LOG.debug("Entering constructor.");

        if (debug) LOG.debug("Setting reorg algo for {}", name);
        this.setReorganizationAlgorithm(TicTacToeReorganizationAlgorithm.createReorganizationAlgorithm(name));
        ...
        if (this.focus == OrganizationFocus.External) {
            ...
            setInitialRoles();
            if (debug)
                LOG.info("Done initializing goals (exiting TicTacToeMaster constructor and continuing to create persona)..........................................................");
        }
    }
