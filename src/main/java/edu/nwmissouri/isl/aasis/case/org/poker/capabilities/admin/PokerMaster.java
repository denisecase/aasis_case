...
import edu.nwmissouri.isl.aasis.case.org.poker.organizer.PokerReorganizationAlgorithm;
 ...
 */
public class PokerMaster extends Master implements IPersonaControlComponentMaster {
    private static final Logger LOG = LoggerFactory.getLogger(PokerMaster.class);
     ...
     */
    public PokerMaster(final String name, final IPersona persona, final Element knowledge, final OrganizationFocus focus) {
        ...
        this.setReorganizationAlgorithm(PokerReorganizationAlgorithm.createReorganizationAlgorithm(name));
