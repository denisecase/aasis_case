...
import edu.nwmissouri.isl.aasis.case.org.tictactoe.guidelines.TicTacToeGuidelineManager;
 ...
 */
public class TicTacToeOrganization extends Organization {
  private static final Logger LOG = LoggerFactory.getLogger(TicTacToeOrganization.class);
   ...
   */
  public TicTacToeOrganization(final String folder, final OrganizationFocus focus, String orgModelFolder) {
    super(folder, focus, orgModelFolder);
    init();
  }

  public TicTacToeOrganization(String folder, OrganizationFocus focus, String orgModelFolder, String goalFilePath,
  ...
  public void init() {
    if (debug)
      LOG.debug("Completed construction external org initializer to load from XML. {}", this.getName());
  }
  ...
  public void loadTopGoalGuidelines() {
    ...
    this.goalParameterValues = TicTacToeGuidelineManager.getGuidelines(absPathToFile);
  ...
  public void loadInitialGoalGuidelines(Map<UniqueIdentifier, Object> goalParameterValues) {
    ...
    IConnections tictactoeConnections = (IConnections) this.getGoalParameterValues()
        .get(TicTacToeGoalParameters.tictactoeConnections);
    ...
    for (IConnectionGuidelines cg : tictactoeConnections.getListConnectionGuidelines()) {
