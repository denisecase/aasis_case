...
public class IssuePokerAssignmentsCapability extends AbstractOrganizationCapability {

    private static final Logger LOG = LoggerFactory.getLogger(IssuePokerAssignmentsCapability.class);
     ...
     */
    public IssuePokerAssignmentsCapability(final IPersona owner, final IOrganization org) {
        super(IssuePokerAssignmentsCapability.class, owner, org);
    }
    ...
    public Set<Agent<?>> getLocalRegisteredProsumers(Set<Agent<?>> allAgents) {
        ...
        final Class<?> capabilityClass = DealPokerCapability.class;
