...
/**
 ...
 their type.
 */
public class TicTacToeOrganizationFactory extends OrganizationFactory {
    private static final Logger LOG = LoggerFactory.getLogger(TicTacToeOrganizationFactory.class);
    private static final Boolean debug = false;


    public TicTacToeOrganizationFactory() {
    super();
  }
  ...
  public IOrganization createBaseAffiliateOrganization(String absolutePath, OrganizationFocus focus,
    ...
    TicTacToeOrganization org = new TicTacToeOrganization(absolutePath, focus, orgModelFolder);
    try {
    ...
    public IOrganization createBaseAffiliateOrganization(String absolutePath,
        ...
        TicTacToeOrganization org = new TicTacToeOrganization(absolutePath, focus, orgModelFolder, goalFilePath,roleFilePath, topGoal);
        try {
            org.setOrgModelFolder(orgModelFolder);
            org.loadInitialGoalGuidelines(goalParameterValues);
            loadObjectFile(org.getOrganizationSpecification().getObjectFile(), org);
