 ...
 */
public class PokerTerminationCriteria extends DefaultTerminationCriteria {
     ...
     */
    public PokerTerminationCriteria(final Organization organization) {
    ...
    public static void setIsDone(final boolean isDone) {
        PokerTerminationCriteria.isDone = isDone;
    }
