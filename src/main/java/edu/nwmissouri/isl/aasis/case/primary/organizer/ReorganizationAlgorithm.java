package edu.nwmissouri.isl.aasis.case.primary.organizer;
...
/**
 The {@code ReorganizationAlgorithm} extends {@code edu.ksu.cis.macr.obaa_pp.cc.reorg.AbstractReorganizationAlgorithm} to provide a custom algorithm for
...
public class ReorganizationAlgorithm extends AbstractReorganizationAlgorithm {
  ...
  public static ReorganizationAlgorithm createReorganizationAlgorithm(final String owner) {
