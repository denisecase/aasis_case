package edu.nwmissouri.isl.aasis.case.org.tictactoe.organizer;
 ...
 */
public class TicTacToeReorganizationAlgorithm extends AbstractReorganizationAlgorithm {

  private static final Logger LOG = LoggerFactory.getLogger(TicTacToeReorganizationAlgorithm.class);
   ...
   */
  private TicTacToeReorganizationAlgorithm(String owner) {
    super();
    TicTacToeReorganizationAlgorithm.owner = owner;
  }

  public static TicTacToeReorganizationAlgorithm createReorganizationAlgorithm(final String owner) {
    return new TicTacToeReorganizationAlgorithm(owner);
  }
