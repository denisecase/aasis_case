 ...
 *
 */
package edu.nwmissouri.isl.aasis.case.org.tictactoe.roles;
...
/**
 ...
 name strings.
 */
public class TicTacToeRoleIdentifiers {

  public static final UniqueIdentifier Play_Poker_Role =  StringIdentifier.getIdentifier("Play Poker Role");
    public static final UniqueIdentifier Deal_Poker_Role =
            StringIdentifier.getIdentifier("Deal Poker Role");

  public static final UniqueIdentifier Play_TicTacToe_Role =
          StringIdentifier.getIdentifier("Play TicTacToe Role");
  public static final UniqueIdentifier Be_Sub_Feeder_Holon_Role =
          StringIdentifier.getIdentifier("Be Sub Feeder Holon Role");
  public static final UniqueIdentifier Be_Sub_Lateral_Holon_Role =
          StringIdentifier.getIdentifier("Be Sub Lateral Holon Role");
  public static final UniqueIdentifier Referee_TicTacToe_Role =
          StringIdentifier.getIdentifier("Referee TicTacToe Role");

  public static final UniqueIdentifier Self_Control_Role =
          StringIdentifier.getIdentifier("Self Control Role");
  ...
  public String toString() {
    try {
      ...
      Logger.getLogger(TicTacToeRoleIdentifiers.class.getName()).log(Level.SEVERE,
              null, ex);
      return "";
    }
