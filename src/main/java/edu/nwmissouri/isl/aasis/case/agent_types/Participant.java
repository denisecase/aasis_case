...
/**
 * A participant in the internal organization of an AASIS Agent.
 */
public class Participant extends BaseAgent {
	/**
	 ...
	 */
	public Participant(final IExecutableOrganization organization, final String name, final Element knowledge) {
